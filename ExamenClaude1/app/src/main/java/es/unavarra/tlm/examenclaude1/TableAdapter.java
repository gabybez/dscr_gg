...
/*
 * ============================================================================
 * ADAPTER: TableAdapter.java
 * ============================================================================
 *
 * El Adapter es el "puente" entre los DATOS (List<Table>) y la VISTA (ListView).
 *
 * Por cada mesa en la lista, el Adapter crea una fila visual.
 *
...
public class TableAdapter extends BaseAdapter {
    //Lista de mesas (Los datos)
    private List<Table> tables;
    //Contexto (la Activity) Necesario para inflar los layouts
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        TextView txtTableNumber = convertView.findViewById(R.id.txt_table_number);
        ImageView imgStatus = convertView.findViewById(R.id.img_status);
        TextView txtCapacity = convertView.findViewById(R.id.txt_capacity);
        TextView txtStatus = convertView.findViewById(R.id.txt_status);

        //Paso 4 Configurar los valores de cada Widget
        txtTableNumber.setText(String.valueOf(table.getId()));
        ...
        if(table.getAvailable()){ //si esta disponible
